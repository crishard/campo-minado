...
15. O jogador deve ser capaz de marcar uma zona com uma bandeira para indicar que ele considera ter uma bomba.
    + Testar se o tabuleiro está sendo criado
...
16. O jogador deve ser capaz de remover uma bandeira previamente colocada em uma zona.
    + Testar se o tabuleiro está sendo criado
...
17. O jogador deve ser capaz de descobrir uma zona que não tenha uma bandeira.
...
18. O jogador não deve ser capaz de descobrir uma zona que contenha uma bandeira
    + verificar se a zona que ele clicou tem bandeira
    + Testar se o estado da zona com bandeira permanece inalterado após o click
    + verificar se a zona que ele clicou já está descoberta
...
19. O jogo deve revelar o número de bombas adjacentes a uma zona quando ela for descoberta.
...
20. O software deve mostrar o tempo decorrido durante a partida.
...
21. Deve haver um botão de pausa visível durante o jogo.
...
22. Com a partida pausada, deve haver um botão de retomar visível durante o jogo
...
23. O jogador não deve conseguir realizar nenhuma ação no jogo com a partida pausada
    + Testar se é possível descobrir uma zona com a partida pausada
    + Testar se é possível adicionar uma bandeira com a partida pausada
    + Testar se é possível remover uma bandeira com a partida pausada
    + Testar se é possível retomar a partida
...
24. Deve ser exibida uma mensagem para o jogador quando a partida estiver pausada
...
25. O  time do jogo deve permanecer inalterado enquanto a partida estiver pausada
...
26. O time do jogo deve continuar assim que a partida for retomada
...
27. Após a partida ser dada como encerrada, o botão de pausa deve permanecer desabilitado
...
28. Assim que a partida for finalizada, o time deve ser parado
    + Testar se o jogador venceu
    + Testar se o jogador perdeu
    + Testar se o time está sendo atualizado
    + Testar se o time foi pausado

29. Deve haver uma opção de tutorial para ensinar as regras básicas do jogo aos novos jogadores.
    ...
    + Testar se o tutorial está sendo exibido corretamente
    + Testar se o botão de voltar para o menu está sendo criado
    + Testar se o botão de voltar para o menu funciona corretamente

30. Deve haver uma opção de retornar ao menu de escolha de nível a partir do tutorial
...
31. O software deve exibir o número de bandeiras disponíveis para uso.
...
32. O número de bandeiras deve ser igual ao número de bombas
...
33. Após adicionar uma bandeira no tabuleiro, o número de bandeiras deve ser atualizado
...
34. Após remover uma bandeira no tabuleiro, o número de bandeiras deve ser atualizado
    + Testar se é possível adicionar uma bandeira no nível fácil
    + Testar se é possível remover uma bandeira no nível fácil
    + Testar se o software atualiza o número de bandeiras disponíveis quando uma bandeira é adicionada no nível fácil
    + Testar se o software atualiza o número de bandeiras disponíveis quando uma bandeira é removida no nível fácil
...
35. O jogador deve ser notificado imediatamente se descobrir uma zona que contenha uma bomba, indicando que a bomba explodiu, e que ele perdeu a partida.
...
36. O software deve fornecer uma mensagem de vitória quando todas as áreas sem bombas forem descobertas corretamente.
...
37. O software deve fornecer a opção de voltar para o menu a partir da mensagem de vitória
...
38. O software deve fornecer a opção de jogar novamente a partir da mensagem de vitória
    + Testar se existe alguma zona com bomba descoberta
    + Testar se existe alguma zona sem bomba coberta
    + Testar se todas as zonas sem bomba foram descobertas
    + Testar se o jogador venceu
...
39. O software deve fornecer uma mensagem de derrota quando uma zona com bomba for descoberta.
    + Testar se a zona clicada está descoberta
    + Testar se a zona clicada está coberta
...
40. O software deve fornecer a opção de voltar para o menu a partir da mensagem de derrota
    + Testar se a zona clicada está descoberta
    + Testar se a zona clicada está coberta
    + Testar se a zona clicada possui bandeira
    + Testar se a zona clicada contém bomba
...
41. O software deve fornecer a opção de jogar novamente a partir da mensagem de derrota
    + Testar se a zona clicada está descoberta
    + Testar se a zona clicada está coberta
    + Testar se a zona clicada possui bandeira
    + Testar se a zona clicada contém bomba
...
42. O software deve verificar se o jogador venceu a partida após cada ação.
...
43. Deve ser possível abandonar a partida a qualquer momento
...
44. Deve ser possível visualizar o menu inicial após abandonar a partida
...
45. O software deve contar com um histórico de partidas
...
46. Cada zona pode ter de zero (0) a oito (8)zonas que contém bomba adjacentes a ela nível fácil
...
47. Cada zona pode ter de zero (0) a oito (8)zonas que contém bomba adjacentes a ela nível intermediário
    + Testar uma zona sem bombas adjacentes
    + Testar uma zona com uma bomba adjacente
    + Testar uma sona com duas bombas adjacentes
    + Testar uma sona com três bombas adjacentes
...
48. Cada zona pode ter de zero (0) a oito (8)zonas que contém bomba adjacentes a ela nível difícil
    + Testar uma zona sem bombas adjacentes
    + Testar uma zona com uma bomba adjacente
    + Testar uma sona com duas bombas adjacentes
    + Testar uma sona com três bombas adjacentes
...
49. Após uma derrota todas as bombas do tabuleiro devem ser exibidas - nível fácil
    + Testar para um tabuleiro sem bombas
    + Testar para um tabuleiro que só contenha bombas
    + Testar para um tabuleiro com o número correto de bombas do nível
    + Testar para um tabuleiro com mais bombas que o esperado
...
50. Após uma derrota todas as bombas do tabuleiro devem ser exibidas - nível intermediário
    + Testar para um tabuleiro sem bombas
    + Testar para um tabuleiro que só contenha bombas
    + Testar para um tabuleiro com o número correto de bombas do nível
    + Testar para um tabuleiro com mais bombas que o esperado
...
51. Após uma derrota todas as bombas do tabuleiro devem ser exibidas - nível difícil
    + Testar para um tabuleiro sem bombas
    + Testar para um tabuleiro que só contenha bombas
    + Testar para um tabuleiro com o número correto de bombas do nível
    + Testar para um tabuleiro com mais bombas que o esperado
...
52. Ao clicar em uma célula cujo valor é zero, devem ser reveladas todas as células adjacentes a ela até que seja encontrado um valor diferente de 0 - para o nível fácil
    + Testar se a zona clicada está descoberta
    + Testar se a zona clicada contém bandeira
    + Testar se a zona clicada está coberta
    + Testar se a zona clicada contém bomba
...
53. Ao clicar em uma célula cujo valor é zero, devem ser reveladas todas as células adjacentes a ela até que seja encontrado um valor diferente de 0 - nível intermediário
    + Testar se a zona clicada está descoberta
    + Testar se a zona clicada contém bandeira
    + Testar se a zona clicada está coberta
    + Testar se a zona clicada contém bomba
...
54. Ao clicar em uma célula cujo valor é zero, devem ser reveladas todas as células adjacentes a ela até que seja
...
55. A partida deve ser iniciada assim que o jogador fizer o primeiro movimento
